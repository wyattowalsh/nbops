...
| G7 / TASK-007 | Convert py/script/md + percent roundtrip | `to_percent_python` / `from_percent_python`; tags and cell ids round-trip including `[md]` and bracket-safe lists; Jupytext YAML kernelspec; omitted ids stay omitted | verified (recovered) |
