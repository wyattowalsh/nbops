...
| G7 / TASK-007 | Convert py/script/md + percent roundtrip | `to_percent_python` / `from_percent_python`; tags, cell ids, and optional Jupytext titles round-trip; `[md]` alias; bracket-safe lists; YAML kernelspec; omitted ids stay omitted | verified (recovered) |
