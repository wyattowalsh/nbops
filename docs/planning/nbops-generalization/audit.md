...
| G8 / TASK-008 | Cell-level diff | `src/nbops/diff.py`; signature is type + source + attachments + tags + outputs; kernelspec/`language_info.name` via `metadata_changed`; `tests/test_diff.py` | verified (recovered) |
