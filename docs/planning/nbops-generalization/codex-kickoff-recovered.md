...
| TASK-007 | Convert to percent py / script / md, plus percent roundtrip | done | `src/nbops/convert.py`; tags, ids, and optional Jupytext titles round-trip; `[md]` alias; YAML kernelspec; omitted ids stay omitted |
